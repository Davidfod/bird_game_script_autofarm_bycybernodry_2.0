...
-- === LISTA DE ROLAGEM (Para caber todos os Plots) ===
local scroll = Instance.new("ScrollingFrame")
scroll.Size = UDim2.new(0, 240, 0, 280)
scroll.Position = UDim2.new(0.5, -120, 0, 50)
scroll.BackgroundTransparency = 1
scroll.BorderSizePixel = 0
scroll.ScrollBarThickness = 4
scroll.CanvasSize = UDim2.new(0, 0, 0, 500) -- Espaço para muitos botões
...
-- === CRIAR BOTÕES DE PLOTS (AGORA ATÉ O 8) ===
for i = 1, 8 do
